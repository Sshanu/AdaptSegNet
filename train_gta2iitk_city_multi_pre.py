...
from dataset.cityscapes_iitk_dataset import cityscapesiitkDataSet
...
IGNORE_LABEL = 255
INPUT_SIZE = '1280,720'
DATA_DIRECTORY_TARGET_1 =  './data/Camera_Dataset/data'
DATA_LIST_PATH_TARGET_1 = './dataset/camera_list/train.txt'
DATA_DIRECTORY_TARGET_2 = './data/Cityscapes/data'
DATA_LIST_PATH_TARGET_2 = './dataset/cityscapes_list/train.txt'
...
def get_arguments():
    ...
    parser.add_argument("--data-dir-target-1", type=str, default=DATA_DIRECTORY_TARGET_1,
                        help="Path to the directory containing the target dataset.")
    parser.add_argument("--data-list-target-1", type=str, default=DATA_LIST_PATH_TARGET_1,
                        help="Path to the file listing the images in the target dataset.")
    parser.add_argument("--data-dir-target-2", type=str, default=DATA_DIRECTORY_TARGET_2,
                        help="Path to the directory containing the target dataset.")
    parser.add_argument("--data-list-target-2", type=str, default=DATA_LIST_PATH_TARGET_2,
                        help="Path to the file listing the images in the target dataset.")
...
def main():
    ...
    targetloader = data.DataLoader(cityscapesiitkDataSet(args.data_dir_target_2, args.data_dir_target_1, args.data_list_target_2, args.data_list_target_1,                                        max_iters=args.num_steps * args.iter_size * args.batch_size,
